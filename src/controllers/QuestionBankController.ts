...
export default class QuestionBankController {
    ...
    static async createQuestion(req: Request, res: Response) {
        try {
            const { question, answer, options, categoryId, creatorName, explaination, multipleCorrectType, pyq, year, acceptance } = req.body;
            ...
            const newQuestion = await QuestionBankService.createQuestion({ question, answer, options, categoryId, creatorName, explaination, multipleCorrectType, pyq, year, acceptance });
